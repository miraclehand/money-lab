...
class KRStockFetcher(StockFetcher):
    ...
    def fetch_data(self, ticker: str = None) -> list:
    ...
    def sync_data(self, ticker: str = None):
        ...
        try:
            stock_data_fetched = self.fetch_data(ticker)
...
if __name__ == '__main__':
    ...
    stock_fetcher_kr = KRStockFetcher()
    #print(stock_fetcher_kr.fetch_stock_group())
    #print(stock_fetcher_kr.fetch_data())
    stock_fetcher_kr.sync_data()
